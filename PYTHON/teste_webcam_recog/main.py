...
benjamin_image = face_recognition.load_image_file("eu.jpeg")

benjamin_face_encoding = face_recognition.face_encodings(benjamin_image)[0]

# Load a second sample picture and learn how to recognize it.
biden_image = face_recognition.load_image_file("teste_facial_recognizement/biden/1.jpg")
biden_face_encoding = face_recognition.face_encodings(biden_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    benjamin_face_encoding, biden_face_encoding
]
known_face_names = [
    "Benjamin",
    "Joe Biden"
